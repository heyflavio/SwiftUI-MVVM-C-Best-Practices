...
As an extra, but important piece, the `Extensions` folder provides a space for reusable utilities and helpers. For this project, it is where you find a View extension for binding Combine publishers to SwiftUI state, and a Publisher extension for mapping and binding Combine publishers.
